...
$query=$conn->prepare("UPDATE teachers SET name='$name',sex='$sex',age='$age',dob='$dob',pob='$pob',phone='$phone',address='$address' WHERE t_id=$id");
...
{
   $id = $_GET['id'];
   $query = $conn->query("SELECT * FROM teachers WHERE t_id=$id");
